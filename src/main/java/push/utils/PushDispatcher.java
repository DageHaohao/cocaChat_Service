...
public class PushDispatcher {
    ...
    //个推框架的基本参数
    private static final String appId = "OmTgg87Hf57DiAzvWdAe34";
    private static final String appKey = "thNeGUPDo86Q4tYct2MI61";
    private static final String masterSecret = "Tv1wLCpo9r9Gkf8JLDXxA4";
    ...
    // 给每个人发送消息的一个Bean封装,构建一个批处理的Bean
